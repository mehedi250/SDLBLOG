...
<div class="card card-teal">
    <div class="card-header">
        <h3 class="card-title">Blog Catagory Update Form</h3>
    </div>
    <!-- /.card-header -->
            ...
            <div class="row col-md-12">
                ...
                <div class="col-md-6 col-sm-12">
                    <div class="form-group">
                        ...
                        <input class="form-control" value="{{$catagory->slug}}" type="text" name="slug" placeholder="slug" id="slug" required>
                        @error('slug') 
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-md-6 col-sm-12">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" type="text" name="description" placeholder="description" id="description" required rows="5">{{$catagory->description}}</textarea>
                        @error('description') 
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
