...
<div class="card card-teal">
    <div class="card-header">
        <h3 class="card-title">Blog Post Add Form</h3>
    </div>
    <!-- /.card-header -->
            ...
            <div class="row col-md-12">
                ...
                <div class="col-md-6 col-sm-12">
                    <div class="form-group">
                        ...
                        <select class="custom-select form-control-border" id="language_id" name="language_id">
                          <option value=""  disabled selected>Select Blog Language</option>
                ...
                <div class="col-md-12 col-sm-12">
                    <div class="form-group">
                       ...
                       <textarea id="summernote" name="post_body"  placeholder="Enter Post Body Content" required>  </textarea>
                        @error('post_body') 
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-md-12 col-sm-12">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" type="text" name="short_description" placeholder="Short Description" id="description" rows="5"></textarea>
                ...
                <div class="col-12 mt-4">
                    <div class="form-group clearfix">
                        <div class="icheck-primary d-inline">
                          <input type="checkbox" id="checkboxPrimary1" name="is_published" checked>
