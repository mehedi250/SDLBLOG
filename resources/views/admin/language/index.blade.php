            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <a class="btn btn-primary btn-xs float-right pl-3 pr-3" href="{{route('languages.create')}}"> Add</a>
                        </div>
                    </div>
                </div>
                <!-- /.card-header -->
                    ...
                    <table id="pageDatatable" class="table table-striped" style="width:100%;">
                        ...
                        @foreach($languages as $language)
                            <tr>
                                ...
                                <td>
                                <a href="{{route('languages.edit',$language->id)}}" class="btn btn-sm btn-primary text-white text-center"><i class="far fa-edit"></i></a>
                                <form style="display:inline;" method="POST" action="{{route('languages.destroy',$language->id)}}">
                                    {{ csrf_field() }}
                                    {{ method_field('DELETE') }}
