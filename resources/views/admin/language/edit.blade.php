...
<div class="card card-teal">
    <div class="card-header">
        <h3 class="card-title">Blog Language Update Form</h3>
    </div>
    <!-- /.card-header -->

    <!-- form start -->
    <form  method="POST" action="{{route('languages.update',$sdlblogLanguage->id)}}" class="form-horizontal" enctype="multipart/form-data" >
        @method('PUT')
        @csrf
        <div class="card-body">
            <div class="row col-md-12">
                <div class="col-md-6 col-sm-12">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="name" placeholder="Name" value="{{$sdlblogLanguage->name}}" id="name" required>
                        @error('name') 
                ...
                <div class="col-md-6 col-sm-12">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="slug" placeholder="slug"  value="{{$sdlblogLanguage->slug}}" id="slug" required>
                        @error('slug') 
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
